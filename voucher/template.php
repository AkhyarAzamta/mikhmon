...
if(substr($timelimit,-1) == "d" & strlen($timelimit) >3){
  ...
  $timelimit = "Paket: ".(substr($timelimit,0,-1)*7)." Minggu";
...
<!-- /  -->
    <tr>
      <!-- Price  -->
      <td colspan="2" style="border-top: 1px solid black;font-weight:bold; font-size:16px"><?= $timelimit; ?> <br/> <?= $price; ?></td>
<!-- /  -->
    </tr>
    <tr>
      <!-- Note  -->
      <td colspan="2" style="font-weight:bold; font-size:12px">Login: http://<?= $dnsname; ?>
		</td>
<!-- /  -->
    </tr>
	      <tr>
      <!-- Note  -->
      <td colspan="2" style="font-weight:bold; font-size:12px">Login: http://10.0.0.1</td>
<!-- /  -->
    </tr>
<!-- /  -->
  </tbody>
